...
{
    [BsonElement("Crude oil - exports")] public CrudeOilExports? CrudeOilExports { get; set; }

    [BsonElement("Crude oil - imports")] public CrudeOilImports? CrudeOilImports { get; set; }
    ...
    [BsonElement("Electricity - exports")] public ElectricityExports? ElectricityExports { get; set; }
    ...
    [BsonElement("Electricity - imports")] public ElectricityImports? CrudeElectricityImports { get; set; }
    ...
    [BsonElement("Electricity - Access")] public ElectricityAccess? ElectricityAccess { get; set; }

    [BsonElement("Natural gas - consumption")]
    public NaturalGasConsumption? NaturalGasConsumption { get; set; }

    [BsonElement("Natural gas - exports")] public NaturalGasExports? NaturalGasExports { get; set; }

    [BsonElement("Natural gas - imports")] public NaturalGasImports? NaturalGasImports { get; set; }
