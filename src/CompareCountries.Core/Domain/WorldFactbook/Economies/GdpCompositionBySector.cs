...
{
    [BsonElement("Agriculture")] public Agriculture? Agriculture { get; set; }

    [BsonElement("Industry")] public Industry? Industry { get; set; }

    [BsonElement("Services")] public Services? Services { get; set; }
}
