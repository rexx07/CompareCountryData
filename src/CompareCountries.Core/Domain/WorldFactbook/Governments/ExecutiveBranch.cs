...
/// </summary>
public class ExecutiveBranch : ExtraNote
{
    [BsonElement("Cabinet")] public Cabinet? Cabinet { get; set; }

    [BsonElement("Chief of state")] public ChiefOfState? ChiefOfState { get; set; }

    [BsonElement("Election results")] public EbElectionResults? ElectionResults { get; set; }

    [BsonElement("Elections/appointments")]
    public ElectionsAppointments? ElectionsAppointments { get; set; }

    [BsonElement("Head of government")] public HeadOfGovernment? HeadOfGovernment { get; set; }
}
