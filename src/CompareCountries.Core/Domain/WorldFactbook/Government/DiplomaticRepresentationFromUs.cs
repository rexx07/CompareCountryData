...
public class DiplomaticRepresentationFromUs
{
    ...
    [BsonElement("Branch offices(s)")]
    public BranchOfficesFromUs? BranchOffices { get; set; }
    [BsonElement("Chief of mission")]
    public ChiefOfMissionFromUs? ChiefOfMission { get; set; }
    ...
    [BsonElement("Mailing address")]
    public MailingAddress? MailingAddress { get; set; }
    [BsonElement("FAX")]
    public TelephoneFromUs? Telephone { get; set; }
}
