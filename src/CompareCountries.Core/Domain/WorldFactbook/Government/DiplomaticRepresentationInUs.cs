...
namespace CompareCountries.Core.Domain.WorldFactbook.Government;
    ...
    {
        [BsonElement("FAX")]
        public FaxInUs? FaxInUs { get; set; }
        [BsonElement("Chancery")]
        public Chancery? Chancery { get; set; }
        [BsonElement("Chief of mission")]
        public ChiefOfMissionInUs? ChiefOfMissionInUs { get; set; }
        [BsonElement("Consulate(s)")]
        public Consulate? Consulate { get; set; }
        [BsonElement("Consulate(s) general")]
        public ConsulateGeneral? ConsulateGeneral { get; set; }
        [BsonElement("Email address and website")]
        public EmailAddressAndWebsiteInUs? EmailAddressAndWebsiteInUs { get; set; }
        [BsonElement("Representative office")]
        public RepresentativeOffice? RepresentativeOffice { get; set; }
        [BsonElement("Telephone")]
        public TelephoneInUs? TelephoneInUs { get; set; }
    }
