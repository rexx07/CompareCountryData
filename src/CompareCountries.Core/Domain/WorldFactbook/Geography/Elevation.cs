...
{
    [BsonElement("Highest Point")]
    public HighesPoint? HighesPoint { get; set; }
    [BsonElement("Lowest Point")]
    public LowestPoint? LowestPoint { get; set; }
    [BsonElement("Mean elevation")]
