...
/// </summary>
public class JudicialBranch : ExtraNote
{
    [BsonElement("Highest courts")] public HighestCourts? HighestCourts { get; set; }

    [BsonElement("Judge selection and term of office")]
    public JudgeSelectnAndTrmsOfOffice? JudgeSelectnAndTrmsOfOffice { get; set; }

    [BsonElement("Subordinate courts")] public SubordinateCourts? SubordinateCourts { get; set; }
}
