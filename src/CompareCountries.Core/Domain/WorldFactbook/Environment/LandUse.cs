...
/// <summary>
///     LandUse is a submodel of Environment model
/// </summary>
public class LandUse
{
    [BsonElement("Agricultural Land")] public AgriculturalLand? AgriculturalLand { get; set; }
    ...
    [BsonElement("Forest Land")] public Forest? Forest { get; set; }

    [BsonElement("Other land uses")] public Other? Other { get; set; }
}
