...
/// </summary>
public class Capital : ExtraNote
{
    [BsonElement("Daylight saving time")] public DaylightSavingTime? DaylightSavingTime { get; set; }

    [BsonElement("Etymology")] public EtymologyCapital? Etymology { get; set; }
    ...
    [BsonElement("Time difference")] public TimeDifference? TimeDifference { get; set; }

    [BsonElement("Time zone note")] public TimeZoneNote? TimeZoneNote { get; set; }
}
