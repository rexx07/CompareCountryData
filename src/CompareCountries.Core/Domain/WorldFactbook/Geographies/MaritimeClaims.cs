...
{
    [BsonElement("Contiguous zone")] public ContiguousZone? ContiguousZone { get; set; }

    [BsonElement("Contiguous shelf")] public ContiguousShelf? ContiguousShelf { get; set; }
    ...
    [BsonElement("Territorial sea")] public TerritorialSea? TerritorialSea { get; set; }
}
